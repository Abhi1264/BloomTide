            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className='lg:ml-40'>
                        <h3 className="text-white font-semibold mb-6 uppercase">services</h3>
                        <ul className="space-y-4">
                            {services.map((service, index) => (
                                <li key={index} className="text-sm hover:text-primaryBlue transition-colors">
                    ...
                    <div className='xl:ml-60 lg:ml-52'>
                        <h3 className="text-white font-semibold mb-6 uppercase">quick links</h3>
                        <ul className="space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center space-x-4 lg:space-x-64 space-y-4 md:space-y-0">
                    ...
                    <p className="text-sm text-[#a1a1a6] order-last md:order-none">
                        © 2024, BloomTide Consulting, All Rights Reserved.
                    </p>
