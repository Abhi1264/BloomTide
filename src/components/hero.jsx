        ...
        <>
            <div className="relative">
                <div className="absolute inset-0 flex justify-center md:justify-center items-center -z-50 md:mt-96 mt-36">
                    <h1 className="text-[5rem] md:text-[10.5rem] xl:text-[17rem] font-pacifico text-transparent bg-clip-text bg-gradient-to-r from-[#08BFF7] to-[#3386EE] opacity-10" aria-hidden="true">BloomTide</h1>
                </div>
            </div>
            <div className="text-center xl:my-24 md:my-16 my-8">
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-6 flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-6">
                        <button className="w-full md:w-auto bg-primaryBlue text-white font-medium py-3 px-6 rounded-md transition-all duration-300 transform hover:scale-105 text-center">Schedule a Consultation</button>
