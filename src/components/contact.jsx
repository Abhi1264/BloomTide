    ...
    return (
        <div className="flex flex-col gap-8 lg:gap-0 lg:flex-row mx-auto justify-between items-center bg-[#f9f9f9] p-16 lg:py-20 lg:px-36">
            <div className="lg:w-1/2 mb-8 md:mb-0">
                <h2 className="text-4xl md:text-5xl font-bold text-black mb-12 lg:mb-6">Have a Project Idea?</h2>
                <img src={questions} alt="Questions" className="rounded-xl w-full lg:w-11/12 h-auto object-cover" />
            </div>
